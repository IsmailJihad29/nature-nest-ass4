...
const NewArival = () => {
    ...
    return (
        <section className="my-14 px-6 md:px-12 lg:px-24"  style={{
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-[70%] mx-auto">
                    ...
                    >
                        <div className="relative h-full w-full overflow-hidden group">
                            ...
                            <div className="absolute bottom-0 p-4 text-white w-full  bg-gradient-to-t from-gray-500 to-transparent">
                                <h3 className="text-lg font-title font-bold text-shadow-md">{product.title}</h3>
                                <p className="text-sm mb-2 font-text">{product.category}</p>
                                <div className="flex items-center justify-between">
                                    <span className="text-green-300  text-lg font-text">${product.price.toFixed(2)}</span>
                                    <button
